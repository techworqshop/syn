      ...
      <form action={action} className="space-y-5">
        ...
        <label className="flex items-start gap-2.5 cursor-pointer text-[13px]" style={{ color: "#4A4640" }}>
          ...
          <span className="leading-relaxed">
            ...
            <Link href="/landing#agb" className="font-medium hover:underline" style={{ color: "#BE123C" }}>{t("register.agbLink", locale)}</Link>
            {" "}{t("register.agb2", locale)}{" "}
            <Link href="/landing#datenschutz" className="font-medium hover:underline" style={{ color: "#BE123C" }}>{t("register.privacyLink", locale)}</Link>
