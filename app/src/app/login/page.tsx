...
const inp = "w-full px-4 py-2.5 rounded-xl bg-neutral-900/70 border border-white/10 focus:outline-none focus:border-rose-500/60 focus:ring-2 focus:ring-rose-500/10 transition-all placeholder:text-neutral-500";
