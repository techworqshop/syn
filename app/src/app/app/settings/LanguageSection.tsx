    ...
    <SettingsSection title={t("settings.language.title", locale)}>
      ...
      <div className="flex gap-2">
        {(["de", "en"] as const).map(l => (
          <button key={l} onClick={() => set(l)} className="px-4 py-2 rounded-md text-sm font-medium transition-colors" style={l === locale ? { background: "#1F2420", color: "#F3EFE2" } : { background: "transparent", color: "#4A4640", border: "1px solid rgba(31,36,32,0.20)" }}>
