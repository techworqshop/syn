...
const BUBBLE: Record<string, string> = {
  ...
  coordinator: "bg-gradient-to-br from-violet-900 via-purple-800 to-rose-700 text-white border border-purple-700/40 shadow-lg bubble-glass",
...
export default function MessageBubble({ m }: { m: Message }) {
  ...
  if (m.role === "coordinator") labelColor = "text-purple-700";
